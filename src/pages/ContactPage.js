       ...
       <div>
           ...
           <div className="ContactPage">
            ...
            <div className="contact-sect">
                <p>More contact methods available in due course. </p>
                {/* <ContactItem icon={phone} text1={"003343403"} text2={"44545"} title={'Phone'}/> */}
                <ContactItem icon={email} text1={"adrian.looney@mail.com"}   title={'Email'}/>
                {/* <ContactItem icon={location} text1={"003343403"}  title={'Address'}/> */}
            </div>
        </div>
       </div>
    )
